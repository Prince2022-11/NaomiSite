...
--
-- Hôte : 127.0.0.1
-- Généré le :  mer. 14 mai 2025 à 10:12
...
(1, 'f', 0, '0001/24-25', 'Non', 'Non', 'Non', 'Non', 'Non', 0, 0, 0, 0, 0, 0, 0, '3', '3'),
(2, 'ggg', 0, '0002/24-25', 'Oui', 'Oui', 'Oui', 'Oui', 'Oui', 0, 3, 6, 7, 6, 5, 0, '3', '3'),
(3, 'Mathématiques', 28, '0002/24-25', 'Oui', 'Oui', 'Oui', 'Oui', 'Oui', 0, 3, 7, 3, 7, 4, 5, '3', '3');
...
INSERT INTO `t_payement_frais` (`id_payement`, `matricule`, `motif`, `montant_payer`, `unite`, `date_payement`, `anneescolaire`, `idEcole`, `idOperateur`) VALUES
...
(2, 'Primar', '2025', 'Prefecture', '3', 'Actif'),
(3, 'Furaha', '2025', 'Caisse', '3', 'Inactif'),
(5, 'FRANCINE', '2025', 'COMPTABLE', '2', 'Inactif'),
(6, 'NEEMA', '2025', 'Admin', 'Toutes les écoles', 'Actif');
...
--
ALTER TABLE `attribution_horaire`
  MODIFY `idAttribution` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `frais_scolaire`
  MODIFY `idfrais` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
...
--
ALTER TABLE `situation_paye`
  MODIFY `idSituation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `t_payement_frais`
  MODIFY `id_payement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;
