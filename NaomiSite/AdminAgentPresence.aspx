<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAgentPresence.aspx.cs" Inherits="NaomiSite.AdminAgentPresence" %>
                                    ...
                                    <ContentTemplate>
                                        <CENTER>
                                         ...
                                         <div class="col-lg-6 col-md-6" style="overflow:auto">
                                             <asp:Label runat="server" ID="txtM" Text="Le personnel Programmé ce " ForeColor="black" Font-Bold="True" AutoPostBack="True" Visible="true" Font-Size="medium"></asp:Label>
                                             <asp:Label runat="server" ID="txtJour" Text="Le personnel Programmé ce " ForeColor="blue" Font-Bold="True" AutoPostBack="True" Visible="true" Font-Size="medium"></asp:Label>
                                               ...
                                               <ItemTemplate>
                                                <tr>
                                                  ...
                                                  <td style="border:1px solid black;"> <%#Eval("nom") +"-"%><%#Eval("prenom") %></td>
                                                    ...
                                                    <td style="border:1px solid black;"> <%#Eval("nombreHeure") %></td>
                                                  <td style="border:1px solid black;">
                                                       <asp:Button runat="server" class="btn btn-primary" ID="PointerPresence" Text="Présent?" type="submit" style="background: #085ecf ;" AutoPostBack="True" OnClick="PointerPresence_Click" CommandArgument= '<%#Eval("Matricule") +","+Eval("nombreHeure") %>'></asp:Button>
                                                      <asp:Button runat="server" class="btn btn-primary" ID="PointerAbsence" Text="Absent?" type="submit" style="background:#ff0000;" AutoPostBack="True" OnClick="PointerAbsence_Click" CommandArgument= '<%#Eval("Matricule") +","+Eval("nombreHeure") %>'></asp:Button>
                                                      <%--<a  id="btnUpdate3" class="btn btn-danger" style="color:white;font-size: small;font-style: normal;border-color:black;font-weight: bold;" href="AdminAgentAbsent.aspx?id=<%#Eval("Matricule") %>">Absent?</a>--%>
                                                      <%--<a  id="btnUpdate1" class="btn btn-success" style="color:white;font-size: small;font-style:normal;border-color:black;font-weight: bold;" onclick="setmatricule('<%# Eval("Matricule") %>')">Présent?</a>--%>
                                                      <%--<a  id="btnUpdate2" class="btn btn-orange" style="color:white;font-size: small;font-style: normal;border-color:black;font-weight: bold;" href="AdminAgentRetard.aspx?id=<%#Eval("Matricule") %>">Retard?</a>--%>
                                         ...
                                         <div class="col-lg-6 col-md-6" style="overflow:auto">
                                             <asp:Label runat="server" ID="sit" Text="Présences/Absences déjà pointées aujourd'hui " ForeColor="black" Font-Bold="True" AutoPostBack="True" Visible="true" Font-Size="medium"></asp:Label>
                                               ...
                                               <ItemTemplate>
                                                <tr>
                                                  <td style="border:1px solid black;"> <%#Eval("nom") +"-"%><%#Eval("prenom") %></td>
                                                    ...
                                                    <td style="border:1px solid black;">
                                                      <asp:Button runat="server" class="btn btn-primary" ID="SupprimerPresenceAbsence" Text="X" type="submit" style="background:#ff0000;" AutoPostBack="True" OnClick="SupprimerPresenceAbsence_Click" CommandArgument= '<%#Eval("Matricule") %>'></asp:Button>
                                                  </td>
                                                </tr>
                                               </ItemTemplate>
