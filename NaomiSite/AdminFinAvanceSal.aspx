<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminFinAvanceSal.aspx.cs" Inherits="NaomiSite.AdminFinAvanceSal" %>
...
<div class="fixed-navbar">
	<div class="pull-left">
		...
		<h1 class="page-title">--- OCTROYER UNE AVANCE SUR SALAIRE A L'AGENT --- </h1>
		<!-- /.page-title -->
	</div>
         ...
         <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:Label runat="server" ID="Label2" Text="Octroyer à : " ForeColor="Black" Font-Bold="True" AutoPostBack="True"></asp:Label>
                                        ...
                                        <asp:Label runat="server" ID="Label1" Text="A une avance salaire de " ForeColor="Black" Font-Bold="True" AutoPostBack="True" Font-Size="Medium"></asp:Label> 
                                          <asp:Label runat="server" ID="txtAvance" Text="0" ForeColor="Red" Font-Bold="True" AutoPostBack="True" Font-Size="Medium"></asp:Label>
                                            <asp:Label runat="server" ID="Label3" Text="USD" ForeColor="Red" Font-Bold="True" AutoPostBack="True" Font-Size="Medium"></asp:Label>
                                            <hr style="border:1px solid red; width:100%; margin:20px auto;">
                                        <asp:Label runat="server" ID="Label0" Text="Sélectionnez un mois à avancer" ForeColor="Black" Font-Bold="True" AutoPostBack="True"></asp:Label>
                                          <div class="form-group input-group" >
                                              <span class="input-group-addon"><span class="glyphicon glyphicon"></span></span> 
                                              <asp:DropDownList ID="txtMois" runat="server"  class="form-control" placeholder="Sélectionnez un sexe" OnSelectedIndexChanged="txtFrais_SelectedIndexChanged" required AutoPostBack="True">
                                          ...
                                          <label>Le montant pris en avance, Si décimal utilisez la virgule (,)</label>
								          <div class="form-group input-group" >
                                                  <span class="input-group-addon"><span class="glyphicon glyphicon-money"></span></span> 
	                                              <asp:TextBox runat="server" ID="txtmontant" class="form-control" placeholder="Saisir ici le montant à avancer" ReadOnly="false"  required AutoPostBack="True"></asp:TextBox>
                                              <span class="input-group-addon"> <span class="fa fa-name"></span><asp:Button runat="server" class="fa fa-download"  ID="btnConvertir" Text="En USD" ForeColor="White" type="submit" style="background: #085ecf ;" AutoPostBack="True"/></span>
	                                      </div> 
                                    ...
                                    <%-- fin de la balise--%>
                                            ...
                                            <%--<asp:Button runat="server" class="btn btn-primary" ID="Button1" Text="Effectuer" type="submit" style="background: #085ecf ;" OnClientClick="confirmPayment(); return false;" OnClick="btnAddStructure_Click"/><span></span>--%>
                                                  <CENTER><asp:Label runat="server" ID="txtMessage" Text="Verifiez bien vos champs ou soit le disponible en caisse est insuffisant pour couvrir l'avance" ForeColor="Red" Font-Bold="True" AutoPostBack="True" Visible="False"></asp:Label></CENTER><br>
