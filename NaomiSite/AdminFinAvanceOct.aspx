<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminFinAvanceOct.aspx.cs" Inherits="NaomiSite.AdminFinAvanceOct" %>
...
<div class="fixed-navbar">
	<div class="pull-left">
		...
		<h1 class="page-title">--- SITUATION DES AVANCES SUR SALAIRE OCTROYEES EN CETTE ANNEE ---</h1>
		<!-- /.page-title -->
	</div>
         ...
         <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                             <CENTER>
                                            <asp:Button runat="server" class="btn btn-primary" ID="btnSituationPresence" Text="Extraire en PDF" type="submit" style="background: #085ecf ;" AutoPostBack="True" OnClick="btnSituationPresence_Click"></asp:Button>
                                        </CENTER>
                                        </div><br /><br />
                                             ...
                                             <table class="table table-condansed table-striped" border="2" style="border:medium ridge black;" >
                                              ...
                                              <tbody>
                                               ...
                                               <ItemTemplate>
                                                <tr>
                                                    <td style="border:1px solid black;"> <%#Eval("dateAvance") %></td>
                                                  ...
                                                  <td style="border:1px solid black;"> <%#Eval("nom") +"-"%><%#Eval("prenom") %></td>
                                                    ...
                                                    <td style="border:1px solid black;"> <%#Eval("montantAvance")+"USD" %></td>
                                                    <td style="border:1px solid black;"> <%#Eval("mois") %></td>
