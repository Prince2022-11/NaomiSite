<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminUtilisateur.aspx.cs" Inherits="NaomiSite.AdminUtilisateur" %>
                                    ...
                                    <ContentTemplate>
                                        <div class="col-lg-6 col-md-6">
								          ...
								          <div class="form-group input-group" >
	                                                ...
	                                                <asp:TextBox runat="server" ID="txtLoginUser" class="form-control" placeholder="Saisir le nom d'utilisateur ici" required AutoPostBack="True"></asp:TextBox>
	                                      </div>
                                        <label>Mot de passe </label>
								          <div class="form-group input-group" >
					                                <span class="input-group-addon"><span class="glyphicon glyphicon-money"></span></span> 
	                                                <asp:TextBox runat="server" ID="txtPassword" class="form-control" placeholder="Saisir le mot de passe de l'utilisateur ici" required AutoPostBack="True"></asp:TextBox>
	                                      </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6"> 
...
<div class="fixed-navbar">
	<div class="pull-left">
		...
		<h1 class="page-title">ESPACE ADMIN --- GESTION DES UTILISATEURS  </h1>
		<!-- /.page-title -->
	</div>
...
<div id="wrapper">
	<div class="main-content">
        ...
        <div class="row" style="overflow:auto">
            <a data-scroll href="#myModal" data-toggle="modal" class="btn btn-primary animation animated-item-3" style="background: #085ecf ;"><h4 style="color: white;">+ Ajouter un utilisateur </h4></a>
            <%--Affichage des etd--%>
