...
<div class="main-menu">
	...
	<header class="header">
		<a href="AdminEspace.aspx" class="logo"><i><img class="img-circle" height="40" width="40" src="../img/slides/favicon.jpg" alt=""></i> MAIRIE DE BUKAVU</a>
...
<div class="fixed-navbar">
	...
	<div class="pull-right">
		<a href="accueil.aspx" style="color: #ffffff;" class="ico-item mdi mdi-logout"></a>
	</div>
	<!-- /.pull-right -->
	</div>
<!-- /.fixed-navbar -->
                ...
                <div class="card-box-a">
                    <div class="card card-primary">
                        ...
                        <div class="card-body" style="margin-top: -60px;">
                            <h1 style="text-align:center; font-size: 100px;background: #085ecf;color:#fff;"> <asp:Label ID="txtTotalETD" runat="server" Text="L" class="centered" ForeColor="WHITE"></asp:Label> </h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card-box-a">
                    <div class="card card-primary">
                        ...
                        <div class="card-body" style="margin-top: -60px;">
                            <h1 style="text-align:center;font-size: 100px;background: #085ecf;color:#fff;"> <asp:Label ID="txtTotalGestionnaireETD" runat="server" Text="L" class="centered" ForeColor="WHITE"></asp:Label> </h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card-box-a">
                    <div class="card card-primary">
                        ...
                        <div class="card-body" style="margin-top: -60px;">
                            <h1 style="text-align:center;font-size: 100px;background: #085ecf;color:#fff;"> <asp:Label ID="txtTotalAgentTerrain" runat="server" Text="L" class="centered" ForeColor="WHITE"></asp:Label> </h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card-box-a">
                    <div class="card card-primary">
                        ...
                        <div class="card-body" style="margin-top: -60px;">
                            <h1 style="text-align:center;font-size: 100px;background: #085ecf;color:#fff;"><asp:Label ID="txtTotalComptable" runat="server" Text="L" class="centered" ForeColor="WHITE"></asp:Label> </h1>
                        </div>
                    </div>
                </div>
            </div>
