<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminFinAvanceSalMenu.aspx.cs" Inherits="NaomiSite.AdminFinAvanceSalMenu" %>
...
<div class="fixed-navbar">
	<div class="pull-left">
		...
		<h2 class="page-title">--- EFFECTUER UNE AVANCE SUR SALAIRE ---</h2>
		<!-- /.page-title -->
	</div>
                                   ...
                                   <ItemTemplate>
                                    <tr>
                                      ...
                                      <td style="border:1px solid black;"> <%#Eval("domaine") %></td>
                                        ...
                                        <td style="border:1px solid black;"><a  id="btnUpdate" class="mdi mdi-select btn btn-danger" style="color:white;font-size: large;font-style: normal;border-color:black;font-weight: bold;" href="AdminFinAvanceSal.aspx?id=<%#Eval("matricule") %>">Octroyer</a></td>
                                    </tr>
                                   </ItemTemplate>
