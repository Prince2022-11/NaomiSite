<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminFinCompteAgent.aspx.cs" Inherits="NaomiSite.AdminFinCompteAgent" %>
...
<div class="fixed-navbar">
	<div class="pull-left">
		...
		<h1 class="page-title">--- COMPTES DE PAYEMENTS DES AGENTS EN CETTE ANNEE ---</h1>
		<!-- /.page-title -->
	</div>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <label id="lblEcole" runat="server">Comptes agent de quelle écoles ?</label>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <label> Agent à détailler :  </label>
                                              <asp:Label runat="server" ID="txtNomAgent" Text="-" ForeColor="Red" Font-Bold="True" AutoPostBack="True"></asp:Label><br />
                                             <CENTER>
                                            <asp:Button runat="server" class="btn btn-primary" ID="btnSituationPresence" Text="Faire des recherches dans les payements" type="submit" style="background: #085ecf ;" AutoPostBack="True" OnClick="btnSituationPresence_Click"></asp:Button>
                                        </CENTER>
                                        </div><br /><br />
                                         </ContentTemplate>
                                            </asp:UpdatePanel>
                                              ...
                                              <tbody>
                                               ...
                                               <ItemTemplate>
                                                <tr>
                                                  ...
                                                  <td style="border:1px solid black;"> <%#Eval("septembre")+"USD" %></td>
                                                    <td style="border:1px solid black;"> <%#Eval("octobre")+"USD" %></td>
                                                    <td style="border:1px solid black;"> <%#Eval("novembre")+"USD" %></td>
                                                    <td style="border:1px solid black;"> <%#Eval("decembre")+"USD" %></td>
                                                    <td style="border:1px solid black;"> <%#Eval("janvier")+"USD" %></td>
                                                    <td style="border:1px solid black;"> <%#Eval("fevrier")+"USD" %></td>
                                                    <td style="border:1px solid black;"> <%#Eval("mars")+"USD" %></td>
                                                    <td style="border:1px solid black;"> <%#Eval("avril")+"USD" %></td>
                                                    <td style="border:1px solid black;"> <%#Eval("mai")+"USD" %></td>
                                                    <td style="border:1px solid black;"> <%#Eval("juin")+"USD" %></td>
                                                    <td style="border:1px solid black;"> <%#Eval("avance")+"USD" %></td>
                                                    <td style="border:1px solid black;">
                                                    <asp:Button runat="server" class="btn btn-primary" ID="btnDetailPayement" Text="Détailler" type="submit" style="background:#075c21;" AutoPostBack="True" OnClick="btnDetailPayement_Click" CommandArgument= '<%#Eval("Matricule") %>'></asp:Button>
                                                   </td>
                                                </tr>
                                               </ItemTemplate>
