    ...
    public partial class AdminRechPayementFrais : System.Web.UI.Page
    {
        ...
        public void SontEnOrdre()
        {
            if (txtTranche.SelectedValue=="Tranche1")
            {
                ...
                conN.Open();
                MySqlCommand cmdN = new MySqlCommand("SELECT SUM(situation_paye.tranche1) as Total FROM change_classe,situation_paye,frais_scolaire WHERE situation_paye.Matricule=change_classe.matricule AND situation_paye.idfrais='" + txtIdFrais.Text + "' AND change_classe.classe='" + txtIdClasse.Text + "'AND change_classe.optionEtude='" + txtIdOption.Text + "' AND situation_paye.anneescolaire='" + txtIdAnnee.Text + "' AND situation_paye.idEcole='" + txtIdEcole.Text + "' AND situation_paye.idFrais=frais_scolaire.idfrais AND frais_scolaire.unite='" + txtUnite.Text + "' AND situation_paye.tranche1='" + txtT1.Text + "'", conN);
            ...
            if (txtTranche.SelectedValue == "Tranche2")
            {
                ...
                Random rnd = new Random();
                Document dc = new Document();
                String chemin = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/ " + rnd.Next() * 1000 + "EleveEnOrdreTranche2.pdf";
                FileStream fs = File.Create(chemin);
                PdfWriter.GetInstance(dc, fs);
                dc.Open();
                dc.Add(new Paragraph("                                                      REPUBLIQUE DEMOCRATIQUE DU CONGO \n", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 12, BaseColor.BLACK)));
                ...
                MySqlConnection conN = new MySqlConnection("server=localhost;uid=root;database=gespersonnel;password=");
                conN.Open();
                MySqlCommand cmdN = new MySqlCommand("SELECT SUM(situation_paye.tranche2) as Total FROM change_classe,situation_paye,frais_scolaire WHERE situation_paye.Matricule=change_classe.matricule AND situation_paye.idfrais='" + txtIdFrais.Text + "' AND change_classe.classe='" + txtIdClasse.Text + "'AND change_classe.optionEtude='" + txtIdOption.Text + "' AND situation_paye.anneescolaire='" + txtIdAnnee.Text + "' AND situation_paye.idEcole='" + txtIdEcole.Text + "' AND situation_paye.idFrais=frais_scolaire.idfrais AND frais_scolaire.unite='" + txtUnite.Text + "' AND situation_paye.tranche2='" + txtT2.Text + "'", conN);
                MySqlDataReader drN = cmdN.ExecuteReader();
                Chunk ck;
                Paragraph pr = new Paragraph();
                while (drN.Read())
            ...
            if (txtTranche.SelectedValue == "Tranche3")
            {
                ...
                Random rnd = new Random();
                Document dc = new Document();
                String chemin = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/ " + rnd.Next() * 1000 + "EleveEnOrdreTranche3.pdf";
                FileStream fs = File.Create(chemin);
                PdfWriter.GetInstance(dc, fs);
                dc.Open();
                dc.Add(new Paragraph("                                                      REPUBLIQUE DEMOCRATIQUE DU CONGO \n", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 12, BaseColor.BLACK)));
                ...
                MySqlConnection conN = new MySqlConnection("server=localhost;uid=root;database=gespersonnel;password=");
                conN.Open();
                MySqlCommand cmdN = new MySqlCommand("SELECT SUM(situation_paye.tranche3) as Total FROM change_classe,situation_paye,frais_scolaire WHERE situation_paye.Matricule=change_classe.matricule AND situation_paye.idfrais='" + txtIdFrais.Text + "' AND change_classe.classe='" + txtIdClasse.Text + "'AND change_classe.optionEtude='" + txtIdOption.Text + "' AND situation_paye.anneescolaire='" + txtIdAnnee.Text + "' AND situation_paye.idEcole='" + txtIdEcole.Text + "' AND situation_paye.idFrais=frais_scolaire.idfrais AND frais_scolaire.unite='" + txtUnite.Text + "' AND situation_paye.tranche3='" + txtT3.Text + "'", conN);
                MySqlDataReader drN = cmdN.ExecuteReader();
                Chunk ck;
                Paragraph pr = new Paragraph();
                while (drN.Read())
        ...
        public void NeSontPasEnOrdre()
        {
            if (txtTranche.SelectedValue == "Tranche1")
            {
                ...
                Random rnd = new Random();
                Document dc = new Document();
                String chemin = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/ " + rnd.Next() * 1000 + "ElevePasEnOrdreTranche1.pdf";
                FileStream fs = File.Create(chemin);
                PdfWriter.GetInstance(dc, fs);
                dc.Open();
                dc.Add(new Paragraph("                                                      REPUBLIQUE DEMOCRATIQUE DU CONGO \n", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 12, BaseColor.BLACK)));
            ...
            if (txtTranche.SelectedValue == "Tranche2")
            {
                ...
                Random rnd = new Random();
                Document dc = new Document();
                String chemin = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/ " + rnd.Next() * 1000 + "ElevePasEnOrdreTranche2.pdf";
                FileStream fs = File.Create(chemin);
                PdfWriter.GetInstance(dc, fs);
                dc.Open();
                dc.Add(new Paragraph("                                                      REPUBLIQUE DEMOCRATIQUE DU CONGO \n", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 12, BaseColor.BLACK)));
            ...
            if (txtTranche.SelectedValue == "Tranche3")
            {
                ...
                Random rnd = new Random();
                Document dc = new Document();
                String chemin = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/ " + rnd.Next() * 1000 + "ElevePasEnOrdreTranche3.pdf";
                FileStream fs = File.Create(chemin);
                PdfWriter.GetInstance(dc, fs);
                dc.Open();
                dc.Add(new Paragraph("                                                      REPUBLIQUE DEMOCRATIQUE DU CONGO \n", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 12, BaseColor.BLACK)));
                ...
                dc.Add(new Paragraph("                                                                          Contacts :  0971368721\n", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 12, BaseColor.BLACK)));
                dc.Add(new Paragraph("                    ------------------------------------------------------------------------------------------------------------------\n\n", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 12, BaseColor.BLACK)));
                dc.Add(new Paragraph("              Ne son pas en ordres avec les payements en  : " + (txtFrais.SelectedValue).ToUpper() + ", " + (txtTranche.SelectedValue).ToUpper() + " /" + (txtDesignationAnnee.Text).ToUpper() + "\n\n", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 12, BaseColor.BLACK)));
                dc.Add(new Paragraph("              Classe de               : " + (txtClasse.SelectedValue) + " " + (txtOption.SelectedValue) + " Au Niveau :" + (txtEcole.SelectedValue) + "\n\n", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 12, BaseColor.BLACK)));
                dc.Add(new Paragraph("              Prévue à payer en (" + (txtUnite.Text) + ") : Tranche1=" + (txtT1.Text) + " ,Tranche2= " + (txtT2.Text) + " ,Tranche1= " + (txtT3.Text) + "\n\n", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 12, BaseColor.BLACK)));
        ...
        public void afficherParDate(string afficherParDate)
        {
            ...
            PdfPCell cell = new PdfPCell(new Paragraph("Matricule", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 7, BaseColor.WHITE)));
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            cell.BackgroundColor = BaseColor.BLACK;
            ...
            else
            {
                ...
                {
                    //===========================================================================
                    PdfPCell cell8 = new PdfPCell(new Paragraph(@Convert.ToString(dr["matricule"]), FontFactory.GetFont(FontFactory.TIMES_ROMAN, 7, BaseColor.BLACK)));
        ...
        public void IntervalleDatePDF()
        {
            ...
            Random rnd = new Random();
            Document dc = new Document();
            String chemin = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/ " + rnd.Next() * 1000 + "PayementIntervalle.pdf";
            FileStream fs = File.Create(chemin);
            PdfWriter.GetInstance(dc, fs);
            dc.Open();
            dc.Add(new Paragraph("                                                      REPUBLIQUE DEMOCRATIQUE DU CONGO \n", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 12, BaseColor.BLACK)));
        ...
        protected void btnCompteELeve_Click(object sender, EventArgs e)
        {
            ...
            Random rnd = new Random();
            Document dc = new Document();
            String chemin = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/ " + rnd.Next() * 1000 + "PaiesAnnuellesEleve.pdf";
            FileStream fs = File.Create(chemin);
            PdfWriter.GetInstance(dc, fs);
            dc.Open();
            dc.Add(new Paragraph("                                                      REPUBLIQUE DEMOCRATIQUE DU CONGO \n", FontFactory.GetFont(FontFactory.TIMES_ROMAN, 12, BaseColor.BLACK)));
