<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminFinPayementFrais.aspx.cs" Inherits="NaomiSite.AdminFinPayementFrais" %>
...
<div class="fixed-navbar">
	<div class="pull-left">
		...
		<h2 class="page-title">ESPACE ADMIN --- EFFECTUER LA PERCEPTION DES FRAIS SCOLAIRES DANS UNE CLASSE </h2>
		<!-- /.page-title -->
	</div>
             ...
             <ContentTemplate>
              <asp:TextBox runat="server" ID="txtIdEcole" ForeColor="Red" Text="" AutoPostBack="True" OnTextChanged="txtIdEcole_TextChanged" Visible="false"></asp:TextBox>
                                     ...
                                     <div class="col-lg-6 col-md-6">
                                         ...
                                         <label>Faire une recherche approfondie</label>
                                          <div class="input-group">
                                               <span class="input-group-addon"> <span class="fa fa-name"></span><asp:Label ID="Label10" runat="server" Text="Recherche " Visible="true"></asp:Label></span>
                                                <asp:TextBox runat="server" ID="txtRecherche" class="form-control"  AutoPostBack="true" placeholder="Nom élève, Ecole,Classe, Section..." OnTextChanged="txtRecherche_TextChanged"></asp:TextBox>
                                          </div>
                                     </div><br/>
                      ...
                      <%--<asp:GridView ID="DataGrid" runat="server" class="table table-condansed table-striped" border="2" style="border:medium ridge deepskyblue;overflow:auto;"
                          ...
                          <Columns>
                              ...
                              <asp:TemplateField HeaderText="Action">
                                  <ItemTemplate>
                                      <button type="button" onclick="AdminFinPayeFraisExecute.aspx?id=<%# Eval("matricule") %>" class="mdi mdi-select btn btn-success" width="8px">Effectuer Opération</button>
                                  </ItemTemplate>
                              </asp:TemplateField>
                          </Columns>
                      </asp:GridView>--%>
                        ...
                        <asp:Repeater ID="Data1" runat="server" OnItemCommand="Data1_ItemCommand">
                                 ...
                                 <table class="table table-condansed table-striped" border="2" style="overflow:auto; border:medium ridge black;" >
                                  ...
                                  <tbody>
                                   ...
                                   <ItemTemplate>
                                    <tr>
                                      <td style="border:1px solid black;"> <%#Eval("idClasse ") %></td>
                                    ...
                                    <td style="border:1px solid black;"> <%#Eval("prenom") %></td>
                                      ...
                                      <td style="border:1px solid black;"> <%#Eval("idEcole ") %></td>
                                        <td style="border:1px solid black;"><a  id="btnUpdate" class="mdi mdi-select btn btn-success" style="color:white;font-size: large;font-style: normal;border-color:black;font-weight: bold;" href="AdminFinPayeFraisExecute.aspx?id=<%#Eval("idClasse") %>">Faire Opération</a></td>
                                    </tr>
                                   </ItemTemplate>
