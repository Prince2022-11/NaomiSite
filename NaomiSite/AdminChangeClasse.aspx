...
<div class="fixed-navbar">
	<div class="pull-left">
		...
		<h2 class="page-title">ESPACE ADMIN --- FAIRE CHANGER LES ELEVES DE CLASSES</h2>
		<!-- /.page-title -->
	</div>
             ...
             <ContentTemplate>
              <asp:TextBox runat="server" ID="txtIdEcole" ForeColor="Red" Text="" AutoPostBack="True" OnTextChanged="txtIdEcole_TextChanged" Visible="false"></asp:TextBox>
                                     ...
                                     <div class="col-lg-6 col-md-6"> 
                                         ...
                                         <CENTER>
                                             <CENTER><asp:Button runat="server" class="btn btn-primary" ID="btnChangerClasse" Text="Faire Passer" type="submit" style="background: #085ecf ;" AutoPostBack="True" OnClick="btnChangerClasse_Click"></asp:Button><span></span></CENTER><br />
